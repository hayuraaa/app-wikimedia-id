...
function DonasiIlustrasi() {
  return (
    <svg viewBox="0 0 420 320" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", height: "100%", maxHeight: "300px" }}>
      {/* Background circle */}
      <circle cx="210" cy="160" r="130" fill="rgba(139,26,42,0.06)" />
      <circle cx="210" cy="160" r="95" fill="rgba(139,26,42,0.05)" />
      ...
      {/* Heart */}
      <path d="M210 108 C210 108 196 94 184 94 C172 94 164 102 164 112 C164 130 210 152 210 152 C210 152 256 130 256 112 C256 102 248 94 236 94 C224 94 210 108 210 108Z" fill="#8b1a2a" opacity="0.15" />
      <path d="M210 112 C210 112 200 102 192 102 C184 102 178 107 178 115 C178 128 210 145 210 145 C210 145 242 128 242 115 C242 107 236 102 228 102 C220 102 210 112 210 112Z" fill="#8b1a2a" opacity="0.9" />

      {/* Floating coins */}
      <circle cx="130" cy="110" r="16" fill="#f8f7f5" stroke="#e5e2dd" strokeWidth="1.5" />
      <text x="130" y="115" textAnchor="middle" fontSize="13" fill="#8b1a2a" fontWeight="700">Rp</text>

      <circle cx="290" cy="100" r="14" fill="#f8f7f5" stroke="#e5e2dd" strokeWidth="1.5" />
      <text x="290" y="105" textAnchor="middle" fontSize="11" fill="#8b1a2a" fontWeight="700">Rp</text>

      <circle cx="308" cy="188" r="11" fill="#f8f7f5" stroke="#e5e2dd" strokeWidth="1.5" />
      <text x="308" y="193" textAnchor="middle" fontSize="9" fill="#8b1a2a" fontWeight="700">Rp</text>

      <circle cx="112" cy="190" r="12" fill="#f8f7f5" stroke="#e5e2dd" strokeWidth="1.5" />
      <text x="112" y="195" textAnchor="middle" fontSize="9" fill="#8b1a2a" fontWeight="700">Rp</text>

      {/* Dotted lines from coins to globe */}
      <line x1="144" y1="118" x2="168" y2="138" stroke="#8b1a2a" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />
      <line x1="276" y1="106" x2="256" y2="130" stroke="#8b1a2a" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />
      <line x1="296" y1="182" x2="272" y2="170" stroke="#8b1a2a" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />
      <line x1="122" y1="185" x2="150" y2="172" stroke="#8b1a2a" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />

      {/* Stars / sparkles */}
      <path d="M336 140 L338 134 L340 140 L346 142 L340 144 L338 150 L336 144 L330 142Z" fill="#8b1a2a" opacity="0.3" />
      <path d="M80 148 L81.5 143 L83 148 L88 149.5 L83 151 L81.5 156 L80 151 L75 149.5Z" fill="#8b1a2a" opacity="0.25" />
      <path d="M268 68 L269 64 L270 68 L274 69 L270 70 L269 74 L268 70 L264 69Z" fill="#8b1a2a" opacity="0.2" />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "12px" }}>
            ...
            <span style={{ fontSize: "11px", color: "#e05070", fontFamily: "var(--font-sans)" }}>Donasi</span>
          </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div className="donasi-layout" style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: "32px", alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              {/* Tentang */}
              <div style={{ backgroundColor: "#fff", border: "1px solid #e5e2dd", borderLeft: "4px solid #8b1a2a", borderRadius: "4px", padding: "32px 36px" }}>
                <span style={{ fontSize: "10px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "#8b1a2a", fontFamily: "var(--font-sans)" }}>◆ Tentang Wikimedia Indonesia</span>
              ...
              <div>
                <div style={{ paddingBottom: "10px", marginBottom: "16px", borderBottom: "3px solid #0d0d0d" }}>
                  <span style={{ fontSize: "11px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "#8b1a2a", fontFamily: "var(--font-sans)" }}>◆ Cara Berdonasi</span>
                ...
                <div style={{ backgroundColor: "#0d0d0d", borderRadius: "4px", padding: "32px 36px", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "24px", flexWrap: "wrap" as const }}>
                  <div style={{ position: "absolute", top: "-50px", right: "-50px", width: "200px", height: "200px", borderRadius: "50%", background: "radial-gradient(circle, rgba(139,26,42,0.25) 0%, transparent 70%)", pointerEvents: "none" }} />
                  ...
                  <div style={{ position: "relative", zIndex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e05070" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                      <span style={{ fontSize: "11px", fontWeight: "700", color: "#e05070", fontFamily: "var(--font-sans)", letterSpacing: "0.08em", textTransform: "uppercase" as const }}>Donasi Sekarang</span>
                    </div>
              ...
              <div style={{ display: "flex", gap: "14px", alignItems: "flex-start", padding: "18px 20px", backgroundColor: "#fff", border: "1px solid #fbbf24", borderLeft: "4px solid #f59e0b", borderRadius: "4px" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: "13px", color: "#5c5a57", fontFamily: "var(--font-sans)", margin: 0, lineHeight: "1.7" }}>
                    ...
                    <a href="mailto:info@wikimedia.or.id" style={{ color: "#8b1a2a", fontWeight: "600", textDecoration: "underline", textUnderlineOffset: "2px" }}>info@wikimedia.or.id</a>.
                  </p>
                </div>
              </div>
            ...
            <div className="donasi-sidebar" style={{ position: "sticky", top: "88px", display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              {/* Tombol donasi */}
              <a href={DONASI_URL} target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "16px 24px", backgroundColor: "#8b1a2a", color: "#fff", textDecoration: "none", borderRadius: "4px", fontSize: "15px", fontWeight: "700", fontFamily: "var(--font-sans)", letterSpacing: "0.04em", transition: "background 0.2s", textAlign: "center" as const }}
                onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#a82235")}
                onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#8b1a2a")}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                Donasi Sekarang
              ...
              <Link href="/tentang#hubungi-kami" style={{ padding: "16px 18px", backgroundColor: "#fff", border: "1px solid #e5e2dd", borderRadius: "4px", textDecoration: "none", display: "block", transition: "border-color 0.2s, box-shadow 0.2s" }}
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#8b1a2a"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,0,0,0.06)"; }}
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "6px" }}>
                    ...
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#8b1a2a" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </div>
                <p style={{ fontSize: "12px", color: "#5c5a57", fontFamily: "var(--font-sans)", margin: 0, lineHeight: "1.6" }}>
                    Kunjungi halaman <span style={{ color: "#8b1a2a", fontWeight: "600" }}>Kontak Kami</span> dan isi formulir.
                </p>
                </Link>
