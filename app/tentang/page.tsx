...
const GALLERY = [
  {
    id: 1,
    title: "WikiLatih Komunitas Banjar",
    year: "2024",
    src: "/gallery/wikilatih-banjar.jpg",
    thumb: "/gallery/wikilatih-banjar.jpg",
    color: "#1a3a2a",
    accent: "#4ade80",
  },
  {
    id: 2,
    title: "Wikidata Hackathon Jakarta",
    year: "2024",
    src: "/gallery/hackathon-jakarta.jpg",
    thumb: "/gallery/hackathon-jakarta.jpg",
    color: "#1a2a3a",
    accent: "#60a5fa",
  },
  {
    id: 3,
    title: "GLAM Digitalisasi Museum",
    year: "2023",
    src: "/gallery/glam-museum.jpg",
    thumb: "/gallery/glam-museum.jpg",
    color: "#2a1a2a",
    accent: "#c084fc",
  },
  {
    id: 4,
    title: "Wikipedia 20th Anniversary",
    year: "2021",
    src: "/gallery/wikipedia-20th.jpg",
    thumb: "/gallery/wikipedia-20th.jpg",
    color: "#1a1a3a",
    accent: "#fb923c",
  },
  {
    id: 5,
    title: "WikiNusantara Konferensi",
    year: "2023",
    src: "/gallery/wikinusantara.jpg",
    thumb: "/gallery/wikinusantara.jpg",
    color: "#2a1a1a",
    accent: "#f87171",
  },
  {
    id: 6,
    title: "Kursus WikiLatih Daring",
    year: "2024",
    src: "/gallery/wikilatih-daring.jpg",
    thumb: "/gallery/wikilatih-daring.jpg",
    color: "#1a2a1a",
    accent: "#34d399",
  },
  {
    id: 7,
    title: "Pelatihan Wikidata Surabaya",
    year: "2023",
    src: "/gallery/wikidata-surabaya.jpg",
    thumb: "/gallery/wikidata-surabaya.jpg",
    color: "#2a2a1a",
    accent: "#fbbf24",
  },
  {
    id: 8,
    title: "Edit-a-thon Wikipedia",
    year: "2024",
    src: "/gallery/editathon.jpg",
    thumb: "/gallery/editathon.jpg",
    color: "#1a2a2a",
    accent: "#22d3ee",
  },
];
...
function GalleryImg({
  ...
  return (
    <div style={{ position: "absolute", inset: 0, backgroundColor: color, ...style }}>
      ...
      {!loaded && (
        <>
          ...
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "80px", height: "80px", borderRadius: "50%", background: `radial-gradient(circle, ${accent}40 0%, transparent 70%)` }} />
          <svg style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", opacity: 0.12 }} width="60" height="60" viewBox="0 0 100 100" fill="none">
            <path d="M10 20 L25 70 L40 30 L50 60 L60 30 L75 70 L90 20" stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          </svg>
        </>
      )}
      {!error && (
...
function MasonryGallery() {
  ...
  // Layout: [big-left | 2×2-right] + full-width strip
  // big-left = index 0 (tall)
  // right-top row = 1, 2
  // right-bottom row = 3, 4
  // strip = 5, 6, 7 (+ repeats)
  ...
  const Cell = ({
    ...
    return (
      <div
        ...
        style={{
          height, borderRadius: "6px", overflow: "hidden", position: "relative", cursor: "pointer",
          transform: visible ? (hov ? "scale(1.015)" : "scale(1)") : "translateY(24px)",
          opacity: visible ? 1 : 0,
          transition: `transform 0.4s cubic-bezier(0.22,1,0.36,1), opacity 0.6s ${delay}s, box-shadow 0.35s ease`,
          boxShadow: hov ? "0 20px 60px rgba(0,0,0,0.38)" : "0 4px 16px rgba(0,0,0,0.16)",
        }}
      >
        <GalleryImg src={item.src} alt={item.title} color={item.color} accent={item.accent} />
        ...
        <div style={{
          position: "absolute", inset: 0,
          background: `radial-gradient(ellipse at 60% 0%, ${item.accent}22 0%, transparent 60%)`,
          opacity: hov ? 1 : 0,
        ...
        <div style={{
          ...
          padding: height > 200 ? "28px 20px 18px" : "16px 14px 12px",
          transform: hov ? "translateY(0)" : "translateY(4px)",
          transition: "transform 0.35s cubic-bezier(0.22,1,0.36,1)",
        }}>
          <div style={{ fontSize: "11px", fontWeight: "700", color: "#fff", fontFamily: "var(--font-serif)", lineHeight: 1.3, marginBottom: "4px" }}>
            {height > 120 ? item.title : ""}
          </div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.5)", fontFamily: "var(--font-sans)" }}>{item.year}</span>
            <span style={{
              fontSize: "9px", fontWeight: "700", letterSpacing: "0.06em",
              color: item.accent, fontFamily: "var(--font-sans)",
              opacity: hov ? 1 : 0, transition: "opacity 0.2s",
              display: "flex", alignItems: "center", gap: "3px",
            }}>
              LIHAT
              <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
            </span>
          </div>
        </div>
  ...
  // Strip cell
  const StripCell = ({ idx, globalIdx }: { idx: number; globalIdx: number }) => {
    const item = GALLERY[idx % GALLERY.length];
    const hov = hoveredIdx === 100 + globalIdx;
    return (
      <div
        onClick={() => setLightbox(idx % GALLERY.length)}
        onMouseEnter={() => setHoveredIdx(100 + globalIdx)}
        onMouseLeave={() => setHoveredIdx(null)}
        style={{
          flexShrink: 0, width: "130px", height: "86px", borderRadius: "5px",
          overflow: "hidden", position: "relative", cursor: "pointer",
          transform: hov ? "scale(1.06)" : "scale(1)",
          transition: "transform 0.3s cubic-bezier(0.22,1,0.36,1), box-shadow 0.3s",
          boxShadow: hov ? `0 8px 24px rgba(0,0,0,0.35), 0 0 0 2px ${item.accent}66` : "0 2px 8px rgba(0,0,0,0.18)",
        }}
      >
        <GalleryImg src={item.src} alt={item.title} color={item.color} accent={item.accent} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 60%)" }} />
        <div style={{ position: "absolute", bottom: "6px", left: "8px", right: "8px" }}>
          <div style={{ fontSize: "8px", color: "rgba(255,255,255,0.55)", fontFamily: "var(--font-sans)" }}>{item.year}</div>
        </div>
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "2px", background: `linear-gradient(90deg, ${item.accent}, transparent)`, opacity: hov ? 1 : 0, transition: "opacity 0.2s" }} />
      </div>
    );
  };
    ...
    <div ref={ref}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gridTemplateRows: "auto auto", gap: "8px" }}>
        ...
        <div style={{ gridColumn: "1", gridRow: "1 / 3" }}>
          <Cell idx={0} height={424} delay={0.05} />
        </div>

        {/* Top right pair */}
        <div style={{ gridColumn: "2", gridRow: "1" }}>
          <Cell idx={1} height={208} delay={0.12} />
        </div>
        <div style={{ gridColumn: "3", gridRow: "1" }}>
          <Cell idx={2} height={208} delay={0.18} />
        </div>

        {/* Bottom right — 2-col sub-grid */}
        <div style={{ gridColumn: "2 / 4", gridRow: "2", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
          <Cell idx={3} height={208} delay={0.24} />
          <Cell idx={4} height={208} delay={0.3} />
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "7px", paddingLeft: "2px", paddingRight: "2px" }}>
          {[...GALLERY, ...GALLERY, ...GALLERY].map((item, i) => (
            <StripCell key={i} idx={i} globalIdx={i} />
          ))}
        </div>
      </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: "rgba(255,255,255,0.06)", color: "#fff", fontSize: "18px",
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: "rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.7)", fontSize: "16px",
                cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
                transition: "all 0.2s",
              }}
            ...
            <div
              ...
              style={{ animation: "slideUp 0.35s cubic-bezier(0.22,1,0.36,1)", maxWidth: "840px", width: "100%" }}
            >
              {/* Accent line top */}
              <div style={{ height: "3px", background: `linear-gradient(90deg, ${item.accent}, transparent)`, borderRadius: "2px 2px 0 0" }} />

              {/* Main image */}
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/10", backgroundColor: item.color, overflow: "hidden" }}>
                <GalleryImg src={item.src} alt={item.title} color={item.color} accent={item.accent} />
                {/* Counter badge */}
                <div style={{
                  position: "absolute", top: "14px", left: "14px",
                  padding: "4px 10px", backgroundColor: "rgba(0,0,0,0.55)", backdropFilter: "blur(8px)",
                  borderRadius: "2px", border: "1px solid rgba(255,255,255,0.12)",
                }}>
                  <span style={{ fontSize: "11px", fontWeight: "700", color: "#fff", fontFamily: "var(--font-sans)", letterSpacing: "0.08em" }}>
              ...
              {/* Caption bar */}
              <div style={{
                backgroundColor: "rgba(255,255,255,0.04)", borderTop: "1px solid rgba(255,255,255,0.08)",
                padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between",
              }}>
                <div>
                  <div style={{ fontSize: "15px", fontWeight: "700", color: "#fff", fontFamily: "var(--font-serif)" }}>{item.title}</div>
                  <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", fontFamily: "var(--font-sans)", marginTop: "2px" }}>{item.year}</div>
                </div>
                <div style={{ display: "flex", gap: "5px" }}>
                  {GALLERY.map((_, i) => (
                    <button key={i} onClick={() => setLightbox(i)}
                      style={{
                        width: i === lightbox ? "22px" : "6px", height: "6px", borderRadius: "3px",
                        border: "none", padding: 0, cursor: "pointer",
                        backgroundColor: i === lightbox ? item.accent : "rgba(255,255,255,0.2)",
              ...
              <div style={{ display: "flex", gap: "5px", marginTop: "6px" }}>
                {GALLERY.map((g, i) => (
                  <div key={i} onClick={() => setLightbox(i)}
                    style={{
                      flex: 1, height: "52px", borderRadius: "3px", overflow: "hidden",
                      position: "relative", cursor: "pointer",
                      outline: i === lightbox ? `2px solid ${item.accent}` : "2px solid transparent",
                      outlineOffset: "1px",
                  ...
                  >
                    <GalleryImg src={g.src} alt={g.title} color={g.color} accent={g.accent} />
                  </div>
                ))}
              </div>
            </div>
...
function ContactForm() {
  ...
  const handleSubmit = async () => {
    ...
    setStatus("success");
    setMsg("Pesan Anda berhasil terkirim! Kami akan menghubungi Anda segera.");
          ...
          <div className="tentang-layout" style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: "40px", alignItems: "start" }}>
            ...
            <div className="reveal">
              <div className="section-border-shimmer" style={{ paddingBottom: "10px", marginBottom: "24px", borderBottom: "3px solid #0d0d0d" }}>
                ...
                <h2 style={{ fontSize: "1.4rem", fontWeight: "700", color: "#0d0d0d", fontFamily: "var(--font-serif)", marginTop: "4px", marginBottom: 0 }}>
                  Perjalanan Wikimedia Indonesia
                </h2>
              </div>
              ...
              <div style={{ marginBottom: "32px", display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <p style={{ fontSize: "14px", color: "#3a3a3a", lineHeight: "1.9", fontFamily: "var(--font-sans)", margin: 0 }}>
                  ...
                  <a href="https://id.wikimedia.org/wiki/Ketua_Umum" target="_blank" rel="noopener noreferrer"
                    style={{ color: "#1e4d7b", fontWeight: "600", textDecoration: "underline", textUnderlineOffset: "2px" }}>di sini</a>.
                </p>
              </div>
            ...
            <div className="reveal" style={{ position: "sticky", top: "88px" }}>
              <div className="section-border-shimmer" style={{ paddingBottom: "10px", marginBottom: "16px", borderBottom: "3px solid #0d0d0d" }}>
                ...
                <h3 style={{ fontSize: "16px", fontWeight: "700", color: "#0d0d0d", fontFamily: "var(--font-serif)", marginTop: "4px", marginBottom: 0 }}>
                  Mengenal Wikimedia Indonesia
                </h3>
              </div>

              {/* YouTube embed — gunakan /embed/ bukan watch?v= */}
        ...
        <div className="reveal" style={{ maxWidth: "760px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ textAlign: "center" as const, marginBottom: "36px" }}>
            ...
            <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.4)", fontFamily: "var(--font-sans)", margin: 0, lineHeight: "1.7" }}>
              Isi formulir di bawah ini dan kami akan menghubungi Anda dalam 1–2 hari kerja.
            </p>
          </div>
