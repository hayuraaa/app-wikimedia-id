      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "16px" }}>
            ...
            <span style={{ fontSize: "11px", color: "#3b8ed4", fontFamily: "var(--font-montserrat)" }}>Menjadi Sukarelawan Wikimedia</span>
          </div>
            ...
            {SECTIONS.map((s) => (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "16px", marginBottom: "16px" }}>
                  ...
                  <div>
                    <span style={{ fontSize: "10px", fontWeight: "700", letterSpacing: "0.08em", textTransform: "uppercase" as const, color: "#6b6966", fontFamily: "var(--font-montserrat)", display: "block", marginBottom: "4px" }}>
                      {s.project}
                    </span>
                    <h2 style={{ fontSize: "1.1rem", fontWeight: "700", color: "#0d0d0d", fontFamily: "var(--font-montserrat)", margin: 0, lineHeight: "1.4" }}>
                      {s.question}
                    </h2>
                  </div>
                </div>
