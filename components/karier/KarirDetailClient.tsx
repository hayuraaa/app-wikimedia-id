...
import type { Karir } from "@/app/karier/[slug]/page";
...
export default function KarirDetailClient({ karir }: { karir: Karir }) {
  useEffect(() => {
    fetch(`${BASE}/karir/${karir.slug}/views`, { method: "POST" }).catch(() => {});
  }, [karir.slug]);
