    ...
    <section className="section-dark" style={{ backgroundColor: "#1a3a5c", padding: "80px 24px", position: "relative", overflow: "hidden" }}>
      ...
      <div className="reveal" style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div className="section-border-shimmer reveal" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "40px", paddingBottom: "16px", borderBottom: "3px solid rgba(255,255,255,0.85)" }}>
          <div>
            <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: "700", color: "#ffffff", fontFamily: "var(--font-montserrat)", marginTop: "4px" }}>Proyek Wikimedia</h2>
          </div>
          <a href="https://id.wikimedia.org/wiki/Halaman_Utama" target="_blank" rel="noopener noreferrer"
            style={{ fontSize: "13px", fontWeight: "600", color: "rgba(255,255,255,0.65)", textDecoration: "none", fontFamily: "var(--font-montserrat)", letterSpacing: "0.04em", whiteSpace: "nowrap" }}
              ...
              {wikiProjects.map((p, idx) => {
                ...
                return (
                  <button key={p.id} className="wiki-tab-btn" onClick={() => setActiveWikiTab(idx)}
                    ...
                    <span style={{ fontSize: "14px", fontWeight: isActive ? "700" : "500", fontFamily: "var(--font-montserrat)", whiteSpace: "nowrap" }}>
                      {p.nama_proyek}
                    </span>
                  </button>
                );
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                      {active.subprojects.map((sp) => (
                        <a key={sp.id} href={sp.url} target="_blank" rel="noopener noreferrer"
                          style={{ display: "inline-flex", alignItems: "center", gap: "5px", padding: "5px 12px", backgroundColor: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "2px", fontSize: "12px", color: "rgba(255,255,255,0.75)", fontFamily: "var(--font-montserrat)", textDecoration: "none", fontWeight: "500", transition: "all 0.15s" }}
