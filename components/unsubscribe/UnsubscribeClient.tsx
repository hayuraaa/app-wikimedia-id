        ...
        <div style={{ padding: "40px 36px", textAlign: "center" }}>
            ...
            <>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                <button
                  ...
                  disabled={processing}
                  style={{ flex: 1, padding: "12px", backgroundColor: "#0C57A8", color: "#fff", border: "none", borderRadius: "4px", fontSize: "13px", fontWeight: "700", fontFamily: "var(--font-montserrat)", cursor: processing ? "not-allowed" : "pointer", opacity: processing ? 0.7 : 1, transition: "background 0.2s" }}
                ...
                <Link href="https://wikimedia.or.id" style={{ flex: 1, padding: "12px", backgroundColor: "#f0eeec", color: "#3a3a3a", borderRadius: "4px", fontSize: "13px", fontWeight: "600", fontFamily: "var(--font-montserrat)", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  Batal
                </Link>
              </div>
            </>
          ...
          {status === "already" && (
            <>
              ...
              <button
                ...
                disabled={processing}
                style={{ padding: "12px 28px", backgroundColor: "#1e4d7b", color: "#fff", border: "none", borderRadius: "4px", fontSize: "13px", fontWeight: "700", fontFamily: "var(--font-montserrat)", cursor: "pointer", marginBottom: "12px" }}
              >
                {processing ? "Memproses..." : "Berlangganan Kembali"}
              </button>
              <br />
              <Link href="https://wikimedia.or.id" style={{ fontSize: "12px", color: "#6b6966", fontFamily: "var(--font-montserrat)" }}>
                Kembali ke Beranda
              </Link>
            </>
          )}
          ...
          {(status === "notfound" || status === "invalid" || status === "error") && (
            <>
              ...
              <Link href="https://wikimedia.or.id" style={{ display: "inline-block", padding: "12px 28px", backgroundColor: "#0d0d0d", color: "#fff", borderRadius: "4px", fontSize: "13px", fontWeight: "700", fontFamily: "var(--font-montserrat)", textDecoration: "none" }}>
                Kembali ke Beranda
              </Link>
            </>
          )}
